<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{route('admin')}}">KASIR</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('admin') }}">KS</a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li class="dropdown ">
              ...
              <ul class="dropdown-menu">
                <li class=""><a class="nav-link" href="{{route('waiter')}}">General Dashboard</a></li>
                {{-- <li><a class="nav-link" href="index.html">Ecommerce Dashboard</a></li> --}}
              </ul>
            </li>
            <li class="menu-header">Entri</li>
            <li class="dropdown ">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-database"></i><span>Entri</span></a>
              <ul class="dropdown-menu">
                <li class=""><a class="nav-link" href="{{ url('/waiter/masakan') }}">Masakan</a></li>
                <li class=""><a class="nav-link" href="{{ url('/waiter/order') }}">Order</a></li>
                {{-- <li><a class="nav-link" href="index.html">Ecommerce Dashboard</a></li> --}}
              </ul>
            </li>
