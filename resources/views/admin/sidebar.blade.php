          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown ">
              ...
              <ul class="dropdown-menu">
                <li class=""><a class="nav-link" href="{{route('admin')}}">General Dashboard</a></li>
            ...
            <li class="dropdown ">
              ...
              <ul class="dropdown-menu">
                <li class=""><a class="nav-link" href="{{ route('meja') }}">Meja</a></li>
                <li class=""><a class="nav-link" href="{{ url('/admin/masakan') }}">Masakan</a></li>
                {{-- <li><a class="nav-link" href="index.html">Ecommerce Dashboard</a></li> --}}
              </ul>
            </li>
